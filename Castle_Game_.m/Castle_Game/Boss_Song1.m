...
test = [E5FLT G5SHP G5SHP F5SHP E5 F5SHP E5FLT B4 E5 E5 E5FLT C5SHP E5FLT E5 F5SHP G5SHP G5SHP F5SHP E5 F5SHP E5FLT B4];
y=[b,b_1,b_2];
bass=[y,y,y,y,y,y,y];
sound([Rest,treb,treb,treb])
sound([bass,bass,bass])
